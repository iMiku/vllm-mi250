...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Force-enable QuickReduce on non-MI300 ROCm archs (gfx90a test only).
    "VLLM_ROCM_FORCE_QUICK_REDUCE": lambda: (os.getenv("VLLM_ROCM_FORCE_QUICK_REDUCE", "False").lower() == "true"),
